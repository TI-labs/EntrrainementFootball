...
public final class AffichageConsole {
     ...
     */
    public static void afficherMenuEntoureAvecOptionSortie(final List<String> options, final String nomMenu, final String sortie) {
        ...
        AffichageConsole.afficherOptionEntouree(0, sortie, longueurLigne);
